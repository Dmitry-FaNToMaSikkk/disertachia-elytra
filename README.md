...
**Цель:** Провести комплексный анализ элемента "элитра" и доказать, что он является не нарушающим баланс элементом, а ключевым инструментом, обеспечивающим **трансгрессивный переход** от локальной к глобальной стадии игры в рамках креативно-ориентированной песочницы.
...
## ГЛАВА 4. ОБОСНОВАНИЕ РОЛИ ЭЛИТРЫ КАК ИНСТРУМЕНТА ТРАНГРЕССИВНОГО ПЕРЕХОДА

### 4.1. От локальной к глобальной стадии игры

Ключевым для понимания роли элитры является отказ от спорного термина "эндгейм" в пользу концепции **трангрессивного перехода**. Minecraft можно условно разделить на две стадии:
